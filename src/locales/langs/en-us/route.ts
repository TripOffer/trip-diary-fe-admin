const route: App.I18n.Schema['translation']['route'] = {
  ...
  '(base)_multi-menu': 'All Tweets',
  '(base)_multi-menu_first': 'Search Tweets',
  '(base)_multi-menu_first_child': 'Menu One Child',
  '(base)_multi-menu_second': 'Pending Tweets',
  '(base)_multi-menu_third': 'Approved Tweets',
  '(base)_multi-menu_fourth': 'Rejected Tweets',
